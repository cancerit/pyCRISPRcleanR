 ...
 * 1_raw_counts_boxplot.html
 * 1_raw_counts_histogram.html
 * 1_raw_counts_correlation_matrix.html

 2. plots based on normalised sgRNA counts
 * 2_normalised_counts_boxplot.html
 * 2_normalised_counts_histogram.html
 * 2_normalised_counts_correlation_matrix.html

 3. plots based on fold changes
 * 3_fold_changes_boxplot.html
 * 3_fold_changes_histogram.html
 * 3_fold_changes_correlation_matrix.html
 ...
 * 4_pr_rc_curve_sgRNA.html
 * 4_roc_curve_sgRNA.html
 * 5_pr_rc_curve_gene.html
 * 5_roc_curve_gene.html
 * 6_depletion_profile_genes.html

 5. plots based on CRISPRcleanR corrected counts
 * 7_CRISPRcleanR_corrected_count_boxplot.html
 * 7_CRISPRcleanR_corrected_count_histogram.html
 * 7_CRISPRcleanR_corrected_count_correlation_matrix.html

 6. plots based on CRISPRcleanR corrected fold chnages
 * 8_CRISPRcleanR_corrected_fold_changes_boxplot.html
 * 8_CRISPRcleanR_corrected_fold_changes_histogram.html
 * 8_CRISPRcleanR_corrected_fold_changes_correlation_matrix.html

 7. 9_Raw_vs_postCRISPRcleanR_segmentation_fold_changes.pdf [generated only when ```--crispr_cleanr``` flag is set]
